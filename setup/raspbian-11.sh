...
cp ./mechatrax-archive-keyring_2016.12.19.3_all.deb /usr/share/keyrings/
...
deb [signed-by=/usr/share/keyrings/mechatrax-archive-keyring_2016.12.19.3_all.deb] $REPO $DIST main contrib non-free
